...
public class ReturnClick : MonoBehaviour {
	...
	//if the Return button is pressed, play the select sound and go back to the main menu
	public void ClickReturn(){
		//find and play the select sound
		_selectSound = this.gameObject.GetComponent<AudioSource> ();
		_selectSound.Play ();
		//wait half a second for the sound to play and then go back to the main menu
